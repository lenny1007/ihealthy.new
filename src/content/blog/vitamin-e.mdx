---
title: "維生素 E 完整指南：脂質過氧化保護、生育醇配比與抗凝血風險"
description: "唯有 α-生育醇能被肝臟有效保留。本文解析維生素 E 如何保護細胞膜脂質免受自由基攻擊、高劑量下的促氧化風險，以及與維生素 K 之間的競爭性拮抗作用。"
...
本文你會學到：天然型與合成型差異、脂質過氧化保護與維生素 K 拮抗、劑量上限。
...
| 特徵 | 天然型 (d-α-tocopherol) | 合成型 (dl-α-tocopherol) | 臨床意義 |
|----------|--------------------------|---------------------------|--------------|
| **來源標示** | RRR-alpha-tocopherol | All-rac-alpha-tocopherol | 天然型活性更高。 |
| **生化效力** | **100% (1.49 IU/mg)** | **~50% (1.10 IU/mg)** | 合成型半數是不活化的。 |
| **關鍵作用** | 防禦脂質過氧化。 | 相同容量但效果減半。 | 選擇時應優先看「d-」前綴。 |
| **安全性上限** | 1,000 mg (1,500 IU) | 1,000 mg (1,100 IU) | **每日上限攝取量 (UL)**。 |
