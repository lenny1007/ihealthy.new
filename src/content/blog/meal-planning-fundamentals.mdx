...
category: "diet"
heroImage: "/images/med_files_0.webp"
---

# 膳食規劃基礎：從 TDEE 到精準營養分配的系統化指南

本文你會學到：BMR、TDEE 計算與依目標訂定的巨量營養素比例。
...
2. **TDEE (總熱量消耗)**：BMR 加上日常活動、工作與運動後的總消耗熱量。
- **減脂策略**：攝取熱量為 TDEE 的 85-90%。
- **增肌策略**：攝取熱量為 TDEE 的 110%。
- **維持策略**：攝取熱量等於 TDEE。
...
- **碳水化合物 (Carbs)**：補足剩餘的熱量。優先選擇中低 GI 的複合型醣類，以維持[穩定的血糖波動](/diabetes-prevention-management/)。
...
- **準備力 (Meal Prep)**：週末花 2 小時預處理蛋白質與切洗蔬菜，能減少忙碌時選擇外食的機率。
